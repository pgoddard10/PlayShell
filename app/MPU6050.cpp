 ...
 * before running, place the module on a completely flat surface (check with a sirit level if possible) and make sure that it 
 * stays still while running this function, the results will be stored in the variables 
 * ax_off, ay_off, az_off, gr_off, gp_off, * gy_off for accel x offset... and gyro roll offset..., 
 * take these values and put them into the MPU6050.h file 
 * (A_OFF_X, A_OFF_Y, * A_OFF_Z, G_OFF_X, G_OFF_Y and G_OFF_Z)
*/
